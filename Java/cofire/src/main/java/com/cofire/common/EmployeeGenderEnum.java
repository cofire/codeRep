...
public enum EmployeeGenderEnum {
    ...
    private EmployeeGenderEnum() {

    }

    private EmployeeGenderEnum(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static String getName(String code) {
        for (EmployeeGenderEnum visitorGender : EmployeeGenderEnum.values()) {
    ...
    public static List<Map<String, String>> getCodeNameList() {
        ...
        for (EmployeeGenderEnum item : EmployeeGenderEnum.values()) {
            m_map = new HashMap<>();
